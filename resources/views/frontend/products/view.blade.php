            ...
            <div class="card-body">
                <div class="row">
                    ...
                    <div class="col-md-8">
                        ...
                        <hr>
                        <div class="row">
                            <label class="me-3 mx-1 fs-6"><s>R$ {{ $products->original_price }},00</s></label>
                        </div>
                        <div class="row">
                            <label class="fw-bold text-primary fs-4 " style="font-size: 25px;">R$ {{ $products->selling_price }},00</label>
                        </div>     
                        <p class="mt-3">
